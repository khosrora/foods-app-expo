...
export default function RecioeDetailsScreen(props) {
    ...
    return (
        ...
        >
            ...
            <View className='w-full absolute flex-row justify-between items-center pt-14'>
                ...
                <TouchableOpacity onPress={() => setFav(!fav)} className='p-2 rounded-full mr-5 bg-white'>
                    <HeartIcon size={hp(3.5)} strokeWidth={4.5} color={`${fav ? 'red' : 'gray'}`} />
                </TouchableOpacity>
            </View>
